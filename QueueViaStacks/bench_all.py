#!/usr/bin/env python3
"""Benchmark every author's Queue via Stacks crate and combine the results.
...
def main() -> int:
    ...
    ap.add_argument("--criterion-home", default=os.path.join(HERE, "target", "criterion"),
                    help="shared criterion directory (default: QueueViaStacks/target/criterion)")
    ...
    violin = os.path.join(home, "queue via stacks", "report", "violin.svg")
    print()
