...
pub fn read_test_cases() -> Vec<TestCase> {
    ...
    let test_cases: Vec<TestCaseDeserialized> =
...
fn test_sum_lists_reverse() {
    for case in read_test_cases() {
        ...
        assert_eq!(
            result, case.reverse_expected,
            "sum_lists_reverse failed for: {}",
            case.description
        );
    }
}
...
#[test]
fn test_sum_lists_forward() {
    for case in read_test_cases() {
        let result = sum_lists_forward(case.a, case.b);
        assert_eq!(
            result, case.forward_expected,
            "sum_lists_forward failed for: {}",
            case.description
        );
    }
}
