#!/usr/bin/env python3
"""Benchmark every author's Sort Stack crate and combine the results.
...
def main() -> int:
    ...
    ap.add_argument("--criterion-home", default=os.path.join(HERE, "target", "criterion"),
                    help="shared criterion directory (default: SortStack/target/criterion)")
    ...
    violin = os.path.join(home, "sort stack", "report", "violin.svg")
    print()
